...
library Metadata {
  ...
  function set(bytes32 key, string memory name, string memory description, string memory image) internal {
  ...
  function set(bytes32 key, MetadataData memory _table) internal {
    set(key, _table.name, _table.description, _table.image);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, MetadataData memory _table) internal {
    set(_store, key, _table.name, _table.description, _table.image);
  }
